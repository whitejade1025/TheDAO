...
var Kr;
function za() {
  return Kr || ((Kr = 1), (Xt.exports = Ha())), Xt.exports;
}
var us = za(),
  Kt = { exports: {} },
  B = {};
...
function Ba() {
  ...
  (S.prototype.isReactComponent = {}),
    (S.prototype.setState = function (m, x) {
  ...
  (M.constructor = T), L(M, S.prototype), (M.isPureReactComponent = !0);
  var D = Array.isArray;
  function A() {}
  ...
  function G(m, x, F, k, z) {
        ...
        case "object":
          switch (m.$$typeof) {
            ...
            case t:
              ...
              break;
            case h:
              return (te = m._init), G(te(m._payload), x, F, k, z);
          }
      }
    if (te)
      return (
    ...
    if (D(m))
      for (var me = 0; me < m.length; me++)
        (k = m[me]), (J = he + ne(k, me)), (te += G(k, x, F, J, z));
    else if (((me = g(m)), typeof me == "function"))
      for (m = me.call(m), me = 0; !(k = m.next()).done; )
        (k = k.value), (J = he + ne(k, me++)), (te += G(k, x, F, J, z));
    else if (J === "object") {
      if (typeof m.then == "function") return G(Z(m), x, F, k, z);
      throw (
        ((x = String(m)),
        Error(
  ...
  return (
    ...
    (B.StrictMode = n),
    (B.Suspense = l),
    (B.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = y),
    ...
    (B.cloneElement = function (m, x, F) {
      ...
      var k = L({}, m.props),
        z = m.key;
      if (x != null)
        for (J in (x.key !== void 0 && (z = "" + x.key), x))
          !O.call(x, J) ||
            J === "key" ||
            J === "__self" ||
            J === "__source" ||
    ...
    (B.createElement = function (m, x, F) {
      var k,
        z = {},
        J = null;
      if (x != null)
    ...
    (B.isValidElement = V),
    (B.lazy = function (m) {
      return { $$typeof: h, _payload: { _status: -1, _result: m }, _init: ee };
    }),
    (B.memo = function (m, x) {
    ...
    (B.startTransition = function (m) {
      ...
      try {
        ...
        x !== null && F.types !== null && (x.types = F.types), (y.T = x);
      }
    }),
    ...
    (B.useActionState = function (m, x, F) {
      return y.H.useActionState(m, x, F);
    }),
    (B.useCallback = function (m, x) {
    ...
    (B.useDeferredValue = function (m, x) {
      return y.H.useDeferredValue(m, x);
    }),
    (B.useEffect = function (m, x) {
      return y.H.useEffect(m, x);
    }),
    (B.useEffectEvent = function (m) {
      return y.H.useEffectEvent(m);
    }),
    (B.useId = function () {
      return y.H.useId();
    }),
    (B.useImperativeHandle = function (m, x, F) {
      return y.H.useImperativeHandle(m, x, F);
    }),
    (B.useInsertionEffect = function (m, x) {
      return y.H.useInsertionEffect(m, x);
    }),
    (B.useLayoutEffect = function (m, x) {
      return y.H.useLayoutEffect(m, x);
    }),
    (B.useMemo = function (m, x) {
      return y.H.useMemo(m, x);
    }),
    (B.useOptimistic = function (m, x) {
      return y.H.useOptimistic(m, x);
    }),
    (B.useReducer = function (m, x, F) {
      return y.H.useReducer(m, x, F);
    }),
    (B.useRef = function (m) {
      return y.H.useRef(m);
    }),
    ...
    (B.useSyncExternalStore = function (m, x, F) {
      return y.H.useSyncExternalStore(m, x, F);
    }),
...
var Qr;
function Wa() {
  return Qr || ((Qr = 1), (Kt.exports = Ba())), Kt.exports;
}
var f = Wa();
const Ya = Ua(f),
  Va = ja({ __proto__: null, default: Ya }, [f]);
var Dn = (e) => {
    throw TypeError(e);
  },
  Ja = (e, t, r) => t.has(e) || Dn("Cannot " + r),
  qt = (e, t, r) => (
    Ja(e, t, "read from private field"), r ? r.call(e) : t.get(e)
  ),
  Ga = (e, t, r) =>
    t.has(e)
...
function Ka(e, t, r, n = {}) {
  ...
  function d() {
    ...
    let R = h(),
      S = R == null ? null : R - u;
    (u = R), l && l({ action: s, location: L.location, delta: S });
  }
  function p(R, S) {
    s = "PUSH";
    let b = dt(L.location, R, S);
    u = h() + 1;
    let T = en(b, u),
      M = L.createHref(b);
    try {
    ...
    o && l && l({ action: s, location: L.location, delta: 1 });
  }
  function g(R, S) {
    s = "REPLACE";
    let b = dt(L.location, R, S);
    ...
    let T = en(b, u),
      M = L.createHref(b);
    i.replaceState(T, "", M),
      o && l && l({ action: s, location: L.location, delta: 0 });
  }
  function E(R) {
    return _n(R);
  }
  let L = {
    ...
    listen(R) {
      ...
      return (
        a.addEventListener(Zr, d),
        (l = R),
        () => {
          a.removeEventListener(Zr, d), (l = null);
        }
      );
    },
    createHref(R) {
...
var st,
  tn = class {
    constructor(e) {
      if ((Ga(this, st, new Map()), e)) for (let [t, r] of e) this.set(t, r);
    }
    get(e) {
...
st = new WeakMap();
var qa = new Set(["lazy", "caseSensitive", "path", "id", "index", "children"]);
function Qa(e) {
  return qa.has(e);
}
var Za = new Set([
...
function ft(e, t, r = [], n = {}, a = !1) {
  return e.map((o, i) => {
    ...
    if (
      ...
      let u = { ...o, id: l };
      return (n[l] = rn(u, t(u))), u;
    } else {
      let u = { ...o, id: l, children: void 0 };
      return (
        (n[l] = rn(u, t(u))),
        o.children && (u.children = ft(o.children, t, s, n, a)),
        u
      );
    }
  });
...
function Nn(e, t = [], r = [], n = "", a = !1) {
  let o = (i, s, l = a, u) => {
    ...
    i.children &&
      ...
      Nn(i.children, t, p, d, l)),
      !(i.path == null && !i.index) &&
        t.push({ path: d, score: uo(d, i.index), routesMeta: p });
  };
  return (
    e.forEach((i, s) => {
      if (i.path === "" || !i.path?.includes("?")) o(i, s);
      else for (let l of An(i.path)) o(i, s, !0, l);
    }),
    t
  );
}
...
function uo(e, t) {
  ...
  return (
    ...
    r
      .filter((a) => !nn(a))
      .reduce((a, o) => a + (no.test(o) ? ao : o === "" ? io : lo), n)
  );
}
function co(e, t) {
  ...
  for (let s = 0; s < n.length; ++s) {
    ...
    Object.assign(a, d.params),
      i.push({
        ...
        pathnameBase: yo(Pe([o, d.pathnameBase])),
        route: p,
      }),
...
function kt(e, t) {
  ...
  let [r, n] = kn(e.path, e.caseSensitive, e.end),
    a = t.match(r);
  if (!a) return null;
  let o = a[0],
    i = o.replace(/(.)\/+$/, "$1"),
    s = a.slice(1);
  return {
    params: n.reduce((u, { paramName: h, isOptional: d }, p) => {
      if (h === "*") {
        let E = s[p] || "";
      ...
      const g = s[p];
      return (
        d && !g ? (u[h] = void 0) : (u[h] = (g || "").replace(/%2F/g, "/")), u
      );
    }, {}),
    pathname: o,
    pathnameBase: i,
...
function mo({ basename: e, pathname: t }) {
  return t === "/" ? e : Pe([e, t]);
}
var In = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Ft = (e) => In.test(e);
function po(e, t = "/") {
  ...
  if (r)
    if (Ft(r)) o = r;
      ...
      r.startsWith("/") ? (o = an(r.substring(1), "/")) : (o = an(r, t));
    }
  else o = t;
  return { pathname: o, search: vo(n), hash: go(a) };
}
function an(e, t) {
...
function gr(e, t, r, n = !1) {
  ...
  typeof e == "string"
    ...
    : ((a = { ...e }),
      ...
      Y(!a.search || !a.search.includes("#"), Qt("#", "search", "hash", a)));
  let o = e === "" || a.pathname === "",
    i = o ? "/" : a.pathname,
    s;
  if (i == null) s = r;
...
function So(e, t) {
  ...
  if (
    ...
    let n = e.navigate[$e] ?? e.navigate,
      a = qe(r.navigate, n, (...o) => {
        let [i, s] = o;
        return {
          to:
            typeof i == "number" || typeof i == "string" ? i : i ? Te(i) : ".",
          ...ln(e, s ?? {}),
        };
      });
    a && ((a[$e] = n), (e.navigate = a));
  }
  if (r.fetch.length > 0) {
    let n = e.fetch[$e] ?? e.fetch,
      a = qe(r.fetch, n, (...o) => {
        let [i, , s, l] = o;
        return { href: s ?? ".", fetcherKey: i, ...ln(e, l ?? {}) };
      });
    a && ((a[$e] = n), (e.fetch = a));
  }
  return e;
...
var Lo = Object.getOwnPropertyNames(Object.prototype).sort().join("\0");
function Po(e) {
  ...
  return (
    t === Object.prototype ||
    t === null ||
    Object.getOwnPropertyNames(t).sort().join("\0") === Lo
  );
}
var Hn = ["POST", "PUT", "PATCH", "DELETE"],
  To = new Set(Hn),
  Mo = ["GET", ...Hn],
  Do = new Set(Mo),
  zn = new Set([301, 302, 303, 307, 308]),
  _o = new Set([307, 308]),
  Zt = {
    state: "idle",
    location: void 0,
  ...
  ot = { state: "unblocked", proceed: void 0, reset: void 0, location: void 0 },
  No = (e) => ({ hasErrorBoundary: !!e.hasErrorBoundary }),
  Bn = "remix-router-transitions",
  Wn = Symbol("ResetLoaderData");
function ds(e) {
  ...
  let n = e.hydrationRouteProperties || [],
    a = e.mapRouteProperties || No,
    o = a;
  if (e.unstable_instrumentations) {
    let c = e.unstable_instrumentations;
    o = (v) => ({ ...a(v), ...bo(c.map((w) => w.route).filter(Boolean), v) });
  }
  let i = {},
    s = ft(e.routes, o, void 0, i),
    l,
    u = e.basename || "/";
  u.startsWith("/") || (u = `/${u}`);
  let h = e.dataStrategy || Fo,
    d = { ...e.future },
    p = null,
    g = new Set(),
    E = null,
    ...
    b = Ae(s, e.history.location, u),
    T = !1,
    M = null,
    D;
  if (b == null && !e.patchRoutesOnNavigation) {
    let c = xe(404, { pathname: e.history.location.pathname }),
      { matches: v, route: w } = Ct(s);
    (D = !0), (b = v), (M = { [w.id]: c });
  } else if (
    (b &&
      !e.hydrationData &&
      Et(b, s, e.history.location.pathname).active &&
      (b = null),
    b)
  )
    if (b.some((c) => c.route.lazy)) D = !1;
    else if (!b.some((c) => wr(c.route))) D = !0;
    else {
      let c = e.hydrationData ? e.hydrationData.loaderData : null,
        v = e.hydrationData ? e.hydrationData.errors : null;
      if (v) {
        let w = b.findIndex((C) => v[C.route.id] !== void 0);
        D = b.slice(0, w + 1).every((C) => !lr(C.route, c, v));
      } else D = b.every((w) => !lr(w.route, c, v));
    }
  else {
    (D = !1), (b = []);
    let c = Et(null, s, e.history.location.pathname);
    c.active && c.matches && ((T = !0), (b = c.matches));
  }
  let A,
    y = {
  ...
  function me() {
    if (
      ((p = e.history.listen(({ action: c, location: v, delta: w }) => {
        if (te) {
          te(), (te = void 0);
          return;
        }
      ...
      t.addEventListener("pagehide", c),
        (ne = () => t.removeEventListener("pagehide", c));
    }
    return y.initialized || Ue("POP", y.location, { initialHydration: !0 }), A;
  }
  function Wt() {
    p && p(),
      ne && ne(),
      g.clear(),
      V && V.abort(),
      y.fetchers.forEach((c, v) => Vt(v)),
      y.blockers.forEach((c, v) => Br(v));
  }
  function Sa(c) {
  ...
  function pe(c, v = {}) {
    c.matches &&
      (c.matches = c.matches.map((P) => {
        let I = i[P.route.id],
          _ = P.route;
        return _.element !== I.element ||
          _.errorElement !== I.errorElement ||
          _.hydrateFallbackElement !== I.hydrateFallbackElement
          ? { ...P, route: I }
          : P;
      })),
      (y = { ...y, ...c });
    let w = [],
      C = [];
    y.fetchers.forEach((P, I) => {
      P.state === "idle" && (z.has(I) ? w.push(I) : C.push(I));
    }),
      z.forEach((P) => {
        !y.fetchers.has(P) && !ee.has(P) && w.push(P);
      }),
      [...g].forEach((P) =>
        P(y, {
          deletedFetchers: w,
  ...
  function Ge(c, v, { flushSync: w } = {}) {
    ...
    v.actionData
      ...
      : (P = null);
    let I = v.loaderData
        ? vn(y.loaderData, v.loaderData, v.matches || [], v.errors)
        : y.loaderData,
      _ = y.blockers;
    _.size > 0 && ((_ = new Map(_)), _.forEach((H, j) => _.set(j, ot)));
    let N = Z ? !1 : Vr(c, v.matches || y.matches),
      $ =
        X === !0 ||
        (y.navigation.formMethod != null &&
          ve(y.navigation.formMethod) &&
    ...
    l && ((s = l), (l = void 0)),
      Z ||
        ...
        (O === "PUSH"
          ...
          : O === "REPLACE" && e.history.replace(c, c.state));
    let U;
    if (O === "POP") {
      let H = se.get(y.location.pathname);
      H && H.has(c.pathname)
        ? (U = { currentLocation: y.location, nextLocation: c })
        : se.has(c.pathname) &&
          (U = { currentLocation: c, nextLocation: y.location });
    } else if (ae) {
      let H = se.get(y.location.pathname);
      H
        ? H.add(c.pathname)
        : ((H = new Set([c.pathname])), se.set(y.location.pathname, H)),
        (U = { currentLocation: y.location, nextLocation: c });
    }
    pe(
      {
  ...
  async function Ir(c, v) {
    if ((W?.resolve(), (W = null), typeof c == "number")) {
      W || (W = En());
      let Q = W.promise;
      return e.history.go(c), Q;
    }
    let w = ir(y.location, y.matches, u, c, v?.fromRouteId, v?.relative),
      { path: C, submission: P, error: I } = sn(!1, w, v),
      _ = y.location,
      N = dt(y.location, C, v && v.state);
    ...
    let H =
      ...
      j = (v && v.flushSync) === !0,
      q = Wr({ currentLocation: _, nextLocation: N, historyAction: U });
    if (q) {
      wt(q, {
        state: "blocked",
        location: N,
  ...
  async function Ue(c, v, w) {
    ...
    if (
      ...
      Ge(v, { matches: I }, { flushSync: _ });
      return;
    }
    let N = Et(I, C, v.pathname);
    if ((N.active && N.matches && (I = N.matches), !I)) {
      let { error: ue, notFoundMatches: ge, route: re } = Jt(v.pathname);
      Ge(
        v,
    ...
    let $ = Ke(e.history, v, V.signal, w && w.submission),
      U = e.getContext ? await e.getContext() : new tn(),
      H;
    if (w && w.pendingError)
      H = [Ie(I).route.id, { type: "error", error: w.pendingError }];
    ...
    j ||
      ((V = null),
      Ge(v, { matches: q || I, ...gn(H), loaderData: Q, errors: de }));
  }
  async function Ca(c, v, w, C, P, I, _, N = {}) {
    Yt();
    let $ = ei(v, w);
    if ((pe({ navigation: $ }, { flushSync: N.flushSync === !0 }), I)) {
      let j = await Rt(C, v.pathname, c.signal);
      if (j.type === "aborted") return { shortCircuited: !0 };
      if (j.type === "error") {
        if (j.partialMatches.length === 0) {
          let { matches: Q, route: de } = Ct(s);
          return {
            matches: Q,
            pendingActionResult: [de.id, { type: "error", error: j.error }],
          };
        }
        let q = Ie(j.partialMatches).route.id;
        return {
          matches: j.partialMatches,
          pendingActionResult: [q, { type: "error", error: j.error }],
        };
      } else if (j.matches) C = j.matches;
      else {
        let { notFoundMatches: q, error: Q, route: de } = Jt(v.pathname);
        return {
          matches: q,
    ...
    if (!H.route.action && !H.route.lazy)
      ...
      let j = Qe(o, i, c, C, H, _ ? [] : n, P),
        q = await tt(c, j, P, null);
      if (((U = q[H.route.id]), !U)) {
        for (let Q of C)
          if (q[Q.route.id]) {
            U = q[Q.route.id];
    ...
    if (Ye(U)) {
      ...
      return (
        N && N.replace != null
          ? (j = N.replace)
          : (j =
              mn(U.response.headers.get("Location"), new URL(c.url), u) ===
              y.location.pathname + y.location.search),
        await He(c, U, !0, { submission: w, replace: j }),
        { shortCircuited: !0 }
      );
    }
    if (Re(U)) {
      let j = Ie(C, H.route.id);
      return (
        (N && N.replace) !== !0 && (O = "PUSH"),
        { matches: C, pendingActionResult: [j.route.id, U, H.route.id] }
      );
    }
    return { matches: C, pendingActionResult: [H.route.id, U] };
  }
  async function La(c, v, w, C, P, I, _, N, $, U, H, j, q) {
    let Q = I || er(v, _),
      de = _ || N || wn(Q),
      ue = !Z && !U;
    if (P) {
      if (ue) {
        let ye = $r(j);
        pe(
          { navigation: Q, ...(ye !== void 0 ? { actionData: ye } : {}) },
          { flushSync: H }
        );
      }
      let K = await Rt(w, v.pathname, c.signal);
      if (K.type === "aborted") return { shortCircuited: !0 };
      if (K.type === "error") {
        if (K.partialMatches.length === 0) {
          let { matches: Xe, route: We } = Ct(s);
          return { matches: Xe, loaderData: {}, errors: { [We.id]: K.error } };
        }
        let ye = Ie(K.partialMatches).route.id;
        return {
        ...
        let { error: ye, notFoundMatches: Xe, route: We } = Jt(v.pathname);
        return { matches: Xe, loaderData: {}, errors: { [We.id]: ye } };
      }
    }
    let ge = l || s,
      { dsMatches: re, revalidatingFetchers: Se } = un(
        c,
        C,
        o,
        i,
      ...
      return (
        Ge(
          v,
          {
            matches: w,
            loaderData: {},
            errors: j && Re(j[1]) ? { [j[0]]: j[1].error } : null,
            ...gn(j),
    ...
    if (ue) {
      ...
      Se.length > 0 && (K.fetchers = Pa(Se)), pe(K, { flushSync: H });
    }
    Se.forEach((K) => {
    ...
    let { loaderResults: rt, fetcherResults: ke } = await Fr(re, Se, c, C);
    if (c.signal.aborted) return { shortCircuited: !0 };
    V && V.signal.removeEventListener("abort", ze),
      Se.forEach((K) => ee.delete(K.key));
    let Le = Lt(rt);
    if (Le)
      return await He(c, Le.result, !0, { replace: $ }), { shortCircuited: !0 };
    if (((Le = Lt(ke)), Le))
      return (
        x.add(Le.key),
        await He(c, Le.result, !0, { replace: $ }),
        { shortCircuited: !0 }
      );
    let { loaderData: Gt, errors: nt } = yn(y, w, rt, j, Se, ke);
    U && y.errors && (nt = { ...y.errors, ...nt });
    let Be = Hr(),
      bt = zr(fe),
    ...
    return {
      ...
      loaderData: Gt,
      errors: nt,
      ...(St ? { fetchers: new Map(y.fetchers) } : {}),
    };
  }
  function $r(c) {
    if (c && !Re(c[1])) return { [c[0]]: c[1].data };
    if (y.actionData)
  ...
  async function Ta(c, v, w, C) {
    Oe(c);
    let P = (C && C.flushSync) === !0,
      I = l || s,
      _ = ir(y.location, y.matches, u, w, v, C?.relative),
      N = Ae(I, _, u),
      $ = Et(N, I, _);
    if (($.active && $.matches && (N = $.matches), !N)) {
      _e(c, v, xe(404, { pathname: _ }), { flushSync: P });
      return;
    }
    let { path: U, submission: H, error: j } = sn(!0, _, C);
    if (j) {
      _e(c, v, j, { flushSync: P });
      return;
    }
    let q = e.getContext ? await e.getContext() : new tn(),
    ...
    F.set(c, { routeId: v, path: U }),
      await Da(c, v, U, N, q, $.active, P, Q, H);
  }
  async function Ma(c, v, w, C, P, I, _, N, $, U) {
    Yt(), F.delete(c);
    let H = y.fetchers.get(c);
    De(c, ti($, H), { flushSync: _ });
    let j = new AbortController(),
      q = Ke(e.history, w, j.signal, $);
    if (I) {
      let ie = await Rt(C, new URL(q.url).pathname, q.signal, c);
      if (ie.type === "aborted") return;
      if (ie.type === "error") {
        _e(c, v, ie.error, { flushSync: _ });
        return;
      } else if (ie.matches) C = ie.matches;
      else {
        _e(c, v, xe(404, { pathname: w }), { flushSync: _ });
        return;
      }
    }
    let Q = _t(C, w);
    if (!Q.route.action && !Q.route.lazy) {
      let ie = xe(405, { method: $.formMethod, pathname: w, routeId: v });
      _e(c, v, ie, { flushSync: _ });
      return;
    }
    ee.set(c, j);
    let de = le,
      ue = Qe(o, i, q, C, Q, n, P),
      ge = await tt(q, ue, P, c),
      re = ge[Q.route.id];
    if (!re) {
      for (let ie of ue)
        if (ge[ie.route.id]) {
      ...
      if (Ye(re))
        if ((ee.delete(c), fe > de)) {
          ...
          return (
            x.add(c),
            De(c, it($)),
            He(q, re, !1, { fetcherSubmission: $, preventScrollReset: N })
          );
      if (Re(re)) {
        _e(c, v, re.error);
        return;
    ...
    let Se = y.navigation.location || y.location,
      ze = Ke(e.history, Se, j.signal),
      rt = l || s,
      ke =
        y.navigation.state !== "idle"
          ? Ae(rt, y.navigation.location, u)
          : y.matches;
    Y(ke, "Didn't find any matches after fetcher action");
    let Le = ++le;
    m.set(c, Le);
    let Gt = it($, re.data);
    y.fetchers.set(c, Gt);
    let { dsMatches: nt, revalidatingFetchers: Be } = un(
      ze,
      P,
      o,
      i,
    ...
    Be.filter((ie) => ie.key !== c).forEach((ie) => {
      let xt = ie.key,
        Gr = y.fetchers.get(xt),
        Fa = it(void 0, Gr ? Gr.data : void 0);
      y.fetchers.set(xt, Fa),
        Oe(xt),
        ie.controller && ee.set(xt, ie.controller);
    }),
      pe({ fetchers: new Map(y.fetchers) });
    let bt = () => Be.forEach((ie) => Oe(ie.key));
    j.signal.addEventListener("abort", bt);
    let { loaderResults: St, fetcherResults: K } = await Fr(nt, Be, ze, P);
    if (j.signal.aborted) return;
    if (
      (j.signal.removeEventListener("abort", bt),
      m.delete(c),
      ee.delete(c),
      Be.forEach((ie) => ee.delete(ie.key)),
      y.fetchers.has(c))
    ) {
      let ie = Ne(re.data);
      y.fetchers.set(c, ie);
    ...
    if (((ye = Lt(K)), ye))
      return x.add(ye.key), He(ze, ye.result, !1, { preventScrollReset: N });
    let { loaderData: Xe, errors: We } = yn(y, ke, St, void 0, Be, K);
    zr(Le),
      y.navigation.state === "loading" && Le > fe
        ? (Y(O, "Expected pending action"),
          V && V.abort(),
          Ge(y.navigation.location, {
            matches: ke,
            loaderData: Xe,
            errors: We,
        ...
        : (pe({
            errors: We,
            loaderData: vn(y.loaderData, Xe, ke, We),
            fetchers: new Map(y.fetchers),
          }),
          (G = !1));
  }
  async function Da(c, v, w, C, P, I, _, N, $) {
    let U = y.fetchers.get(c);
    De(c, it($, U ? U.data : void 0), { flushSync: _ });
    let H = new AbortController(),
      j = Ke(e.history, w, H.signal);
    if (I) {
      let re = await Rt(C, new URL(j.url).pathname, j.signal, c);
      if (re.type === "aborted") return;
      if (re.type === "error") {
        _e(c, v, re.error, { flushSync: _ });
        return;
    ...
    let Q = le,
      de = Qe(o, i, j, C, q, n, P),
      ge = (await tt(j, de, P, c))[q.route.id];
    if ((ee.get(c) === H && ee.delete(c), !j.signal.aborted)) {
      if (z.has(c)) {
        De(c, Ne(void 0));
        return;
      }
      if (Ye(ge))
        if (fe > Q) {
          ...
          x.add(c), await He(j, ge, !1, { preventScrollReset: N });
          return;
        }
      if (Re(ge)) {
        _e(c, v, ge.error);
  ...
  async function He(
    ...
    w || (W?.resolve(), (W = null)),
      v.response.headers.has("X-Remix-Revalidate") && (G = !0);
    let N = v.response.headers.get("Location");
    Y(N, "Expected a Location header on the redirect Response"),
      (N = mn(N, new URL(c.url), u));
    let $ = dt(y.location, N, { _isRedirect: !0 });
    if (r) {
      let de = !1;
      if (v.response.headers.has("X-Remix-Reload-Document")) de = !0;
      else if (Ft(N)) {
        const ue = _n(N, !0);
        de = ue.origin !== t.location.origin || be(ue.pathname, u) == null;
      }
      if (de) {
        _ ? t.location.replace(N) : t.location.assign(N);
        return;
      }
    }
    V = null;
    let U =
        _ === !0 || v.response.headers.has("X-Remix-Replace")
          ? "REPLACE"
          : "PUSH",
      { formMethod: H, formAction: j, formEncType: q } = y.navigation;
    !C && !P && H && j && q && (C = wn(y.navigation));
    let Q = C || P;
    if (_o.has(v.response.status) && Q && ve(Q.formMethod))
      await Ue(U, $, {
        submission: { ...Q, formAction: N },
        preventScrollReset: I || X,
  ...
  async function tt(c, v, w, C) {
    let P,
      I = {};
    try {
      P = await Uo(h, c, v, C, w, !1);
    } catch (_) {
      return (
        v
          .filter((N) => N.shouldLoad)
          .forEach((N) => {
            I[N.route.id] = { type: "error", error: _ };
          }),
        I
      );
    }
    if (c.signal.aborted) return I;
    if (!ve(c.method))
      for (let _ of v) {
        if (P[_.route.id]?.type === "error") break;
        !P.hasOwnProperty(_.route.id) &&
          !y.loaderData.hasOwnProperty(_.route.id) &&
          (!y.errors || !y.errors.hasOwnProperty(_.route.id)) &&
          _.shouldCallHandler() &&
          (P[_.route.id] = {
            type: "error",
            result: new Error(
              `No result returned from dataStrategy for route ${_.route.id}`
            ),
          });
      }
    for (let [_, N] of Object.entries(P))
      if (Ko(N)) {
        let $ = N.result;
        I[_] = { type: "redirect", response: Wo($, c, _, v, u) };
      } else I[_] = await Bo(N);
    return I;
  }
  async function Fr(c, v, w, C) {
    let P = tt(w, c, C, null),
      I = Promise.all(
        v.map(async ($) => {
          if ($.matches && $.match && $.request && $.controller) {
            let H = (await tt($.request, $.matches, C, $.key))[
              $.match.route.id
            ];
            return { [$.key]: H };
          } else
            return Promise.resolve({
              [$.key]: { type: "error", error: xe(404, { pathname: $.path }) },
            });
        })
      ),
      _ = await P,
      N = (await I).reduce(($, U) => Object.assign($, U), {});
    return { loaderResults: _, fetcherResults: N };
  }
  function Yt() {
    (G = !0),
      F.forEach((c, v) => {
        ee.has(v) && ce.add(v), Oe(v);
      });
  }
  function De(c, v, w = {}) {
    y.fetchers.set(c, v),
  ...
  function _e(c, v, w, C = {}) {
    let P = Ie(y.matches, v);
    Vt(c),
      pe(
        { errors: { [P.route.id]: w }, fetchers: new Map(y.fetchers) },
  ...
  function _a(c, v) {
    Oe(c, v?.reason), De(c, Ne(null));
  }
  function Vt(c) {
    let v = y.fetchers.get(c);
    ee.has(c) && !(v && v.state === "loading" && m.has(c)) && Oe(c),
      F.delete(c),
      m.delete(c),
      x.delete(c),
      z.delete(c),
  ...
  function Oa(c) {
    let v = (k.get(c) || 0) - 1;
    v <= 0 ? (k.delete(c), z.add(c)) : k.set(c, v),
      pe({ fetchers: new Map(y.fetchers) });
  }
  function Oe(c, v) {
    let w = ee.get(c);
    w && (w.abort(v), ee.delete(c));
  }
  function Ur(c) {
    for (let v of c) {
      let w = jr(v),
  ...
  function Hr() {
    ...
    for (let w of x) {
      ...
      Y(C, `Expected fetcher: ${w}`),
        C.state === "loading" && (x.delete(w), c.push(w), (v = !0));
    }
    return Ur(c), v;
  }
  function zr(c) {
    ...
    for (let [w, C] of m)
      if (C < c) {
        let P = y.fetchers.get(w);
        Y(P, `Expected fetcher: ${w}`),
          P.state === "loading" && (Oe(w), m.delete(w), v.push(w));
      }
    return Ur(v), v.length > 0;
  }
  function Na(c, v) {
    let w = y.blockers.get(c) || ot;
    return J.get(c) !== v && J.set(c, v), w;
  }
  function Br(c) {
    y.blockers.delete(c), J.delete(c);
  }
  function wt(c, v) {
    let w = y.blockers.get(c) || ot;
    Y(
    ...
    C.set(c, v), pe({ blockers: C });
  }
  function Wr({ currentLocation: c, nextLocation: v, historyAction: w }) {
    if (J.size === 0) return;
    J.size > 1 && oe(!1, "A router only supports one blocker at a time");
    let C = Array.from(J.entries()),
      [P, I] = C[C.length - 1],
      _ = y.blockers.get(P);
    if (
      !(_ && _.state === "proceeding") &&
      I({ currentLocation: c, nextLocation: v, historyAction: w })
    )
      return P;
  }
  function Jt(c) {
    let v = xe(404, { pathname: c }),
      w = l || s,
      { matches: C, route: P } = Ct(w);
    return { notFoundMatches: C, route: P, error: v };
  }
  function Aa(c, v, w) {
    if (((E = c), (R = v), (L = w || null), !S && y.navigation === Zt)) {
      S = !0;
      let C = Vr(y.location, y.matches);
      C != null && pe({ restoreScrollPosition: C });
    }
    return () => {
      (E = null), (R = null), (L = null);
    };
  }
  function Yr(c, v) {
    return (
    ...
    if (e.patchRoutesOnNavigation)
      if (c) {
        if (Object.keys(c[0].params).length > 0)
          return { active: !0, matches: ut(v, w, u, !0) };
      } else return { active: !0, matches: ut(v, w, u, !0) || [] };
    return { active: !1, matches: null };
  }
  async function Rt(c, v, w, C) {
    ...
    for (;;) {
      ...
      if ($) {
        ...
        if (
          ((U = ut(_, v, u, !0)),
          !(U && P.length < U.length && Jr(P, U.slice(0, P.length))))
        )
          return { type: "success", matches: $ };
      }
      if ((U || (U = ut(_, v, u, !0)), !U || Jr(P, U)))
  ...
  function Jr(c, v) {
    return (
      c.length === v.length && c.every((w, C) => w.route.id === v[C].route.id)
    );
  }
  function Ia(c) {
    (i = {}), (l = ft(c, o, void 0, i));
...
function ir(e, t, r, n, a, o) {
  ...
  let l = gr(n || ".", vr(i), be(e.pathname, r) || e.pathname, o === "path");
  if (
    ...
    if (s.route.index && !u)
      ...
      let h = new URLSearchParams(l.search),
        d = h.getAll("index");
      h.delete("index"),
        d.filter((g) => g).forEach((g) => h.append("index", g));
      let p = h.toString();
      l.search = p ? `?${p}` : "";
    }
  }
  return (
    r !== "/" && (l.pathname = mo({ basename: r, pathname: l.pathname })), Te(l)
  );
}
function sn(e, t, r) {
  if (!r || !Ao(r)) return { path: t };
  if (r.formMethod && !Zo(r.formMethod))
...
`,
  ...
  let s, l;
  if (r.formData) (s = ur(r.formData)), (l = r.formData);
  else if (r.body instanceof FormData) (s = ur(r.body)), (l = r.body);
  else if (r.body instanceof URLSearchParams) (s = r.body), (l = pn(s));
  else if (r.body == null) (s = new URLSearchParams()), (l = new FormData());
  else
    try {
      (s = new URLSearchParams(r.body)), (l = pn(s));
    } catch {
      return n();
    }
  let u = {
  ...
  let h = Fe(t);
  return (
    e && h.search && Er(h.search) && s.append("index", ""),
    (h.search = `?${s}`),
    { path: Te(h), submission: u }
  );
}
function un(e, t, r, n, a, o, i, s, l, u, h, d, p, g, E, L, R, S, b, T, M) {
  let D = T ? (Re(T[1]) ? T[1].error : T[1].data) : void 0,
    A = a.createURL(o.location),
    y = a.createURL(l),
    O;
  if (h && o.errors) {
    let Z = Object.keys(o.errors)[0];
    O = i.findIndex((G) => G.route.id === Z);
  } else if (T && Re(T[1])) {
    let Z = T[0];
    O = i.findIndex((G) => G.route.id === Z) - 1;
  }
  let W = T ? T[1].statusCode : void 0,
    X = W && W >= 400,
    V = {
      currentUrl: A,
    ...
    se = i.map((Z, G) => {
      ...
      if (
        (O != null && G > O
          ...
          : wr(ce)
          ? h
            ? (ee = lr(ce, o.loaderData, o.errors))
            : ko(o.loaderData, o.matches[G], Z) && (ee = !0)
          : (ee = !1),
        ee !== null)
      )
        return sr(r, n, e, ae, Z, u, t, ee);
      let le = !1;
      typeof M == "boolean"
        ? (le = M)
        : X
        ? (le = !1)
        : (d ||
            A.pathname + A.search === y.pathname + y.search ||
            A.search !== y.search ||
            Io(o.matches[G], Z)) &&
          (le = !0);
      let fe = { ...V, defaultShouldRevalidate: le },
        m = ct(Z, fe);
      return sr(r, n, e, ae, Z, u, t, m, fe, M);
    }),
    ne = [];
  return (
    E.forEach((Z, G) => {
      if (h || !i.some((k) => k.route.id === Z.routeId) || g.has(G)) return;
      ...
      let fe = _t(le, Z.path),
        ...
        F = null;
      if (p.has(G)) p.delete(G), (F = Qe(r, n, x, le, fe, u, t));
      else if (ee) d && (F = Qe(r, n, x, le, fe, u, t));
      else {
        let k;
        typeof M == "boolean" ? (k = M) : X ? (k = !1) : (k = d);
        let z = { ...V, defaultShouldRevalidate: k };
        ct(fe, z) && (F = Qe(r, n, x, le, fe, u, t, z));
      }
      F &&
        ne.push({
          key: G,
...
function cn(e, t, r, n, a, o) {
  ...
  if (
    (t.forEach((u) => {
      let h = i.find((d) => Yn(u, d));
      h ? l.push({ existingRoute: h, newRoute: u }) : s.push(u);
    }),
    s.length > 0)
  ) {
    let u = ft(s, a, [e || "_", "patch", String(i?.length || "0")], n);
    i.push(...u);
  }
  if (o && l.length > 0)
...
function Yn(e, t) {
  return "id" in e && "id" in t && e.id === t.id
    ...
    ? (!e.children || e.children.length === 0) &&
      ...
      ? !0
      : e.children.every((r, n) => t.children?.some((a) => Yn(r, a)))
    : !1;
}
var dn = new WeakMap(),
  Vn = ({ key: e, route: t, manifest: r, mapRouteProperties: n }) => {
    let a = r[t.id];
    if (
...
function $o(e, t, r, n, a) {
  ...
  for (let h of i) {
    ...
    let d = Vn({ key: h, route: e, manifest: r, mapRouteProperties: n });
    d && (s.push(d), h === t && (l = d));
  }
...
async function Fo(e) {
  return e.matches.some((t) => t.route.middleware) ? Jn(e, () => hn(e)) : hn(e);
}
function Jn(e, t) {
  return jo(
    e,
...
async function jo(e, t, r, n, a) {
  let {
    ...
    h = o.flatMap((p) =>
      p.route.middleware ? p.route.middleware.map((g) => [p.route.id, g]) : []
    );
  return await Gn(
...
async function Gn(e, t, r, n, a, o, i = 0) {
  let { request: s } = e;
  if (s.signal.aborted)
  ...
  let [u, h] = l,
    ...
    p = async () => {
      ...
      try {
        return (d = { value: await Gn(e, t, r, n, a, o, i + 1) }), d.value;
      } catch (g) {
        return (d = { value: await o(g, u, d) }), d.value;
      }
    };
  try {
    let g = await h(e, p),
      E = g != null ? n(g) : void 0;
    return a(E) ? E : d ? E ?? d.value : ((d = { value: await p() }), d.value);
  } catch (g) {
    return await o(g, u, d);
  }
}
function Xn(e, t, r, n, a) {
  let o = Vn({
    ...
    i = $o(n.route, ve(r.method) ? "action" : "loader", t, e, a);
  return {
    middleware: o,
...
function sr(e, t, r, n, a, o, i, s, l = null, u) {
  let h = !1,
    d = Xn(e, t, r, a, o);
  return {
    ...a,
    ...
    shouldCallHandler(p) {
      return (
        ...
        l
          ? typeof u == "boolean"
            ? ct(a, { ...l, defaultShouldRevalidate: u })
            : typeof p == "boolean"
            ? ct(a, { ...l, defaultShouldRevalidate: p })
            : ct(a, l)
          : s
      );
    },
    resolve(p) {
      let { lazy: g, loader: E, middleware: L } = a.route,
        R = h || s || (p && !ve(r.method) && (g || E)),
        S = L && L.length > 0 && !E && !g;
      return R && (ve(r.method) || !S)
        ? Ho({
            request: r,
            unstable_pattern: n,
            match: a,
  ...
  return n.map((l) =>
    l.route.id !== a.route.id
      ? {
          ...
          shouldCallHandler: () => !1,
          _lazyPromises: Xn(e, t, r, l, o),
          resolve: () => Promise.resolve({ type: "data", result: void 0 }),
        }
      : sr(e, t, r, mt(n), l, o, i, !0, s)
  );
}
...
async function Ho({
  ...
  let s,
    ...
    d = (p) => {
      let g,
        E = new Promise((S, b) => (g = b));
      (l = () => g()), e.signal.addEventListener("abort", l);
      let L = (S) =>
          typeof p != "function"
            ? Promise.reject(
                new Error(
        ...
        R = (async () => {
          try {
            return { type: "data", result: await (o ? o((b) => L(b)) : L()) };
          } catch (S) {
  ...
  try {
    ...
    if (n || a)
      if (p) {
        ...
        if (g) [s] = await Promise.all([d(g), a]);
        else if (h === "action") {
          let E = new URL(e.url),
            L = E.pathname + E.search;
          throw xe(405, { method: e.method, pathname: L, routeId: r.route.id });
...
async function Bo(e) {
  ...
  if (jt(t)) {
    ...
    return r === "error"
      ? {
          type: "error",
          error: new je(t.status, t.statusText, n),
          statusCode: t.status,
          headers: t.headers,
        }
...
function Wo(e, t, r, n, a) {
  ...
  if (
    ...
    (o = ir(new URL(t.url), i, a, o)), e.headers.set("Location", o);
  }
  return e;
}
function mn(e, t, r) {
  ...
  return (
    e.forEach((d) => {
      ...
      let p = d.route.id,
        g = t[p];
      if (
        (Y(!Ye(g), "Cannot handle redirect results in processLoaderData"),
        Re(g))
      ) {
        let E = g.error;
        if ((h !== void 0 && ((E = h), (h = void 0)), (i = i || {}), a))
          i[p] = E;
        else {
          let L = Ie(e, p);
        ...
        n || (o[p] = Wn),
          l || ((l = !0), (s = Ve(g.error) ? g.error.status : 500)),
...
function yn(e, t, r, n, a, o) {
  let { loaderData: i, errors: s } = Yo(t, r, n);
  return (
    a
      ...
      .forEach((l) => {
        ...
        let p = o[u];
        if ((Y(p, "Did not find corresponding fetcher result"), Re(p))) {
          let g = Ie(e.matches, h?.route.id);
          (s && s[g.route.id]) || (s = { ...s, [g.route.id]: p.error }),
            e.fetchers.delete(u);
        } else if (Ye(p)) Y(!1, "Unhandled fetcher revalidation redirect");
        else {
          let g = Ne(p.data);
          e.fetchers.set(u, g);
        }
...
function Go(e) {
  return (
    e != null &&
    typeof e == "object" &&
    Object.entries(e).every(([t, r]) => typeof t == "string" && Xo(r))
  );
}
function Xo(e) {
  return (
...
function Ko(e) {
  return jt(e.result) && zn.has(e.result.status);
}
function Re(e) {
  return e.type === "error";
}
...
function Qo(e) {
  return jt(e) && qo(e.status) && e.headers.has("Location");
}
function Zo(e) {
...
var qn = f.createContext(!1);
function Qn() {
  return f.useContext(qn);
}
var Rr = f.createContext({ isTransitioning: !1 });
Rr.displayName = "ViewTransition";
var Zn = f.createContext(new Map());
Zn.displayName = "Fetchers";
var ai = f.createContext(null);
ai.displayName = "Await";
var Ee = f.createContext(null);
Ee.displayName = "Navigation";
var Ut = f.createContext(null);
Ut.displayName = "Location";
...
var ea = "REACT_ROUTER_ERROR",
  oi = "REDIRECT",
  ii = "ROUTE_ERROR_RESPONSE";
function li(e) {
  if (e.startsWith(`${ea}:${oi}:{`))
    try {
  ...
  if (e.startsWith(`${ea}:${ii}:{`))
    try {
      ...
      if (
        ...
        return new je(t.status, t.statusText, t.data);
    } catch {}
}
function ui(e, { relative: t } = {}) {
  Y(pt(), "useHref() may be used only in the context of a <Router> component.");
...
function di() {
  ...
  return (
    ...
    f.useCallback(
      (l, u = {}) => {
        if ((oe(i.current, ta), !i.current)) return;
        if (typeof l == "number") {
          r.go(l);
          return;
        }
        let h = gr(l, JSON.parse(o), a, u.relative === "path");
        e == null &&
          t !== "/" &&
...
var fi = f.createContext(null);
function hi(e) {
  let t = f.useContext(Ce).outlet;
  return f.useMemo(
    () => t && f.createElement(fi.Provider, { value: e }, t),
    [t, e]
  );
}
function Sr() {
...
function yt(e, { relative: t } = {}) {
  let { matches: r } = f.useContext(Ce),
    { pathname: n } = Me(),
    a = JSON.stringify(vr(r));
  return f.useMemo(() => gr(e, JSON.parse(a), n, t === "path"), [e, a, n, t]);
}
...
var yi = f.createElement(pi, null),
  na = class extends f.Component {
    constructor(e) {
      super(e),
        (this.state = {
          location: e.location,
      ...
      let t =
        e !== void 0
          ? f.createElement(
              ...
              f.createElement(br.Provider, {
                value: e,
                children: this.props.component,
              })
            )
          : this.props.children;
      return this.context ? f.createElement(vi, { error: e }, t) : t;
    }
  };
na.contextType = qn;
var tr = new WeakMap();
function vi({ children: e, error: t }) {
...
function gi({ routeContext: e, match: t, children: r }) {
...
function wi(e, t = [], r = null, n = null, a = null) {
  if (e == null) {
    if (!r) return null;
  ...
  if (r)
    for (let h = 0; h < o.length; h++) {
      let d = o[h];
      if (
        ((d.route.HydrateFallback || d.route.hydrateFallbackElement) && (l = h),
        d.route.id)
      ) {
  ...
  return o.reduceRight((h, d, p) => {
    let g,
      ...
      R = null;
    r &&
      ((g = i && d.route.id ? i[d.route.id] : void 0),
      (L = d.route.errorElement || yi),
      s &&
        (l < 0 && p === 0
          ? (aa(
              "route-fallback",
            ...
            (R = null))
          : l === p &&
            ((E = !0), (R = d.route.hydrateFallbackElement || null))));
      ...
      b = () => {
        ...
        return (
          g
            ...
            ? (T = R)
            : d.route.Component
            ? (T = f.createElement(d.route.Component, null))
            : d.route.element
            ? (T = d.route.element)
            : (T = h),
          f.createElement(gi, {
...
function Cr() {
  ...
  return f.useMemo(() => e.map((r) => On(r, t)), [e, t]);
}
function Lr() {
...
var Rn = {};
function aa(e, t, r) {
  !t && !Rn[e] && ((Rn[e] = !0), oe(!1, r));
}
var bn = {};
function dr(e, t) {
  !e && !bn[t] && ((bn[t] = !0), console.warn(t));
}
var Ci = "useOptimistic",
  Sn = Va[Ci],
  Li = () => {};
function Pi(e) {
  return Sn ? Sn(e) : [e, Li];
...
var hs = ["HydrateFallback", "hydrateFallbackElement"],
  Ti = class {
    constructor() {
      (this.status = "pending"),
...
function ms({
  ...
  let [o, i] = f.useState(e.state),
    [s, l] = Pi(o),
    [u, h] = f.useState(),
    [d, p] = f.useState({ isTransitioning: !1 }),
    [g, E] = f.useState(),
    [L, R] = f.useState(),
    [S, b] = f.useState(),
    T = f.useRef(new Map()),
    M = f.useCallback(
      (
        ...
        X &&
          ...
          Object.values(X).forEach((ne) =>
            r(ne, {
              ...
              unstable_pattern: mt(O.matches),
            })
          ),
          O.fetchers.forEach((ne, Z) => {
            ne.data !== void 0 && T.current.set(Z, ne.data);
          }),
          W.forEach((ne) => T.current.delete(ne)),
          dr(
            V === !1 || t != null,
        ...
        if (
          ...
          t && V
            ...
            ? i(O)
            : f.startTransition(() => {
                n === !0 && l((ne) => xn(ne, O)), i(O);
              });
          return;
        }
        if (t && V) {
          t(() => {
            L && (g?.resolve(), L.skipTransition()),
              p({
                isTransitioning: !0,
                flushSync: !0,
          ...
          ne.finished.finally(() => {
            t(() => {
              E(void 0), R(void 0), h(void 0), p({ isTransitioning: !1 });
            });
          }),
            t(() => R(ne));
          return;
      ...
      [e.window, t, L, g, n, l, r]
    );
  f.useLayoutEffect(() => e.subscribe(M), [e, M]),
    f.useEffect(() => {
      d.isTransitioning && !d.flushSync && E(new Ti());
    }, [d]),
    f.useEffect(() => {
      if (g && u && e.window) {
        let O = u,
    ...
    f.useEffect(() => {
      g && u && s.location.key === u.location.key && g.resolve();
    }, [g, L, s.location, u]),
    f.useEffect(() => {
      !d.isTransitioning &&
        S &&
  ...
  let D = f.useMemo(
    ...
    A = e.basename || "/",
    y = f.useMemo(
      () => ({ router: e, navigator: D, static: !1, basename: A, onError: r }),
      [e, D, A, r]
    );
...
var Mi = f.memo(Di);
function Di({ routes: e, future: t, state: r, onError: n }) {
  return mi(e, void 0, r, n, t);
}
function ps(e) {
  return hi(e.context);
}
  ...
  let {
    ...
    E = f.useMemo(() => {
      ...
      return L == null
        ? null
        : {
            location: { pathname: L, search: h, hash: d, state: p, key: g },
            navigationType: n,
          };
    }, [s, u, h, d, p, g, n]);
  return (
    ...
    E == null
      ...
      : f.createElement(
          Ee.Provider,
          { value: l },
          f.createElement(Ut.Provider, { children: t, value: E })
        )
  );
}
function Oi() {
  return { params: Sr(), loaderData: Lr(), actionData: Pr(), matches: Cr() };
}
function ys(e) {
  return function () {
    const r = Oi();
...
function Ni() {
  return { params: Sr(), loaderData: Lr(), actionData: Pr() };
}
function vs(e) {
  return function () {
    const r = Ni();
...
function Ai() {
  return { params: Sr(), loaderData: Lr(), actionData: Pr(), error: Tr() };
}
function gs(e) {
  return function () {
    const r = Ai();
...
function ji(e, t) {
  return e.button === 0 && (!t || t === "_self") && !Fi(e);
}
var Pt = null;
function Ui() {
  if (Pt === null)
...
function zi(e, t) {
  ...
  if (Ii(e)) {
    ...
    (n = s ? be(s, t) : null),
      ...
      (a = rr(e.getAttribute("enctype")) || Nt),
      (o = new FormData(e));
  } else if (ki(e) || ($i(e) && (e.type === "submit" || e.type === "image"))) {
    let s = e.form;
    if (s == null)
      throw new Error(
    ...
    if (
      ((n = l ? be(l, t) : null),
      (r = e.getAttribute("formmethod") || s.getAttribute("method") || Ot),
      (a =
        rr(e.getAttribute("formenctype")) ||
        rr(s.getAttribute("enctype")) ||
        Nt),
      (o = new FormData(s, e)),
      !Ui())
    ) {
...
function fr(e) {
  ...
  return (t.length = r.length), Cn.call(this, n);
}
function Cn(e) {
        ...
        switch (d) {
          ...
          case ia:
            if (t[p]) u((t[l] = t[p]));
              ...
              const M = new la();
              (n[p] = M), u((t[l] = M.promise));
            }
            continue;
          case oa:
            const [, S, b] = h;
            let T = b && nr && nr[b] ? new nr[b](S) : new Error(S);
            (t[l] = T), u(T);
            continue;
          case al:
            u((t[l] = t[p]));
...
async function ll(e) {
  ...
  return { done: t.done, value: fr.call(this, r) };
}
async function sl(e) {
  let t = await e.read();
  for (; !t.done; ) {
...
function pl(e, t, r, n, a, o = () => !0) {
  return async (i) => {
    let { request: s, matches: l, fetcherKey: u } = i,
      h = e();
    if (s.method !== "GET") return yl(i, r, a);
    let d = l.some((p) => {
      let { hasLoader: g, hasClientLoader: E } = t(p);
      return p.shouldCallHandler() && g && !E;
    });
    return !n && !d
      ? vl(i, t, r, a)
      : u
...
async function yl(e, t, r) {
  ...
  we(n, "No action match found");
  let a,
    o = await n.resolve(
      async (i) =>
        await i(async () => {
          let { data: l, status: u } = await t(e, r, [n.route.id]);
          return (a = u), ht(l, n.route.id);
        })
    );
  return jt(o.result) || Ve(o.result) || cr(o.result)
    ? { [n.route.id]: o }
    : { [n.route.id]: { type: o.type, result: Eo(o.result, a) } };
}
...
async function gl(e, t, r, n, a, o, i = () => !0) {
  let s = new Set(),
    l = !1,
    u = e.matches.map(() => Ln()),
    h = Ln(),
    d = {},
    p = Promise.all(
      e.matches.map(async (E, L) =>
        E.resolve(async (R) => {
          u[L].resolve();
          let S = E.route.id,
            { hasLoader: b, hasClientLoader: T, hasShouldRevalidate: M } = r(E),
            D =
          ...
          if (!E.shouldCallHandler(D)) {
            l || (l = E.shouldRevalidateArgs != null && b && M === !0);
            return;
          }
          if (i(E) && T) {
            b && (l = !0);
  ...
  return await p, await wl(h.promise, e.matches, s, d), d;
}
async function wl(e, t, r, n) {
  try {
    let a,
      o = await e;
    if ("routes" in o) {
    ...
    a !== void 0 &&
      Array.from(r.values()).forEach((i) => {
        n[i].result instanceof sa && (n[i].result = a);
      });
  } catch {}
}
async function El(e, t, r) {
  let n = e.matches.find((i) => i.shouldCallHandler());
  we(n, "No fetcher match found");
  let a = n.route.id,
...
async function bl(e, t, r) {
  let { request: n } = e,
    a = ua(n.url, t, "data");
  n.method === "GET" &&
    ((a = Rl(a)), r && a.searchParams.set("_routes", r.join(",")));
  let o = await fetch(a, await ul(n));
  if (o.status >= 400 && !o.headers.has("X-Remix-Response"))
    throw new je(o.status, o.statusText, await o.text());
  ...
  we(o.body, "No response body to decode");
  try {
    let i = await Sl(o.body, window),
      s;
    if (n.method === "GET") {
      let l = i.value;
      hr in l ? (s = { redirect: l[hr] }) : (s = { routes: l });
    } else {
      let l = i.value,
        u = r?.[0];
      we(u, "No routeId found for single fetch call decoding"),
  ...
  return il(e, {
    plugins: [
      (r, ...n) => {
        ...
        if (r === "ErrorResponse") {
          let [a, o, i] = n;
          return { value: new je(o, i, a) };
        }
        if (r === "SingleFetchRedirect") return { value: { [hr]: n[0] } };
...
function ht(e, t) {
  ...
  let r = e.routes[t];
  if (r == null) throw new sa(`No result found for routeId "${t}"`);
...
async function Cl(e) {
  if (!e.css) return;
  let t = da(e);
  await Promise.all(t.map(ha));
}
async function fa(e, t) {
  if ((!e.css && !t.links) || !Dl()) return;
  let r = [];
  if (
...
function Dr(e, t, { includeHydrateFallback: r } = {}) {
  return Tl(
    e
      .map((n) => {
...
function ma(e, t) {
  let r = new Set(),
    n = new Set(t);
  return e.reduce((a, o) => {
    if (t && !Mr(o) && o.as === "script" && o.href && n.has(o.href)) return a;
    let s = JSON.stringify(Ml(o));
...
function Mt(e, t) {
  if ((e === "loader" && !t.hasLoader) || (e === "action" && !t.hasAction)) {
    ...
    throw (console.error(n), new je(400, "Bad Request", new Error(n), !0));
  }
}
function ar(e, t) {
  ...
  throw (console.error(n), new je(405, "Method Not Allowed", new Error(n), !0));
}
function _r(e, t, r, n, a, o = "", i = pa(e), s) {
  return (i[o] || []).map((l) => {
    let u = t[l.id];
    function h(b) {
      return (
    ...
    function p(b) {
      if (!l.hasAction) throw ar("action", l.id);
      return h(b);
    }
    function g(b) {
      import(b);
    ...
    if (u) {
      Object.assign(R, {
        ...
        handle: u.handle,
        shouldRevalidate: Tn(R.path, u, l, n, s),
      });
      let b = r && r.loaderData && l.id in r.loaderData,
        T = b ? r?.loaderData?.[l.id] : void 0,
        M = r && r.errors && l.id in r.errors,
        D = M ? r?.errors?.[l.id] : void 0,
        A = s == null && (u.clientLoader?.hydrate === !0 || !l.hasLoader);
      (R.loader = async (
        { request: y, params: O, context: W, unstable_pattern: X },
        V
      ) => {
        try {
          return await L(
            async () => (
              we(u, "No `routeModule` available for critical-route loader"),
              u.clientLoader
                ? u.clientLoader({
                    request: y,
                    params: O,
        ...
        (R.loader.hydrate = kl(l.id, u.clientLoader, l.hasLoader, a)),
        (R.action = (
          { request: y, params: O, context: W, unstable_pattern: X },
          V
        ) =>
          L(async () => {
            if (
              (we(u, "No `routeModule` available for critical-route action"),
              !u.clientAction)
            ) {
              if (a) throw ar("clientAction", l.id);
              return p(V);
            }
            return u.clientAction({
              ...
              unstable_pattern: X,
              async serverAction() {
                return Mt("action", l), p(V);
              },
            });
          }));
    } else {
      l.hasClientLoader || (R.loader = (M, D) => L(() => d(D))),
        l.hasClientAction ||
          (R.action = (M, D) =>
            L(() => {
              if (a) throw ar("clientAction", l.id);
      ...
      R.lazy = {
        ...
        action: l.hasClientAction
          ? async () => {
              let M = l.clientActionModule ? import(l.clientActionModule) : T();
              E(l);
        ...
        middleware: l.hasClientMiddleware
          ? async () => {
              let { clientMiddleware: M } = l.clientMiddlewareModule
                ...
                : await T();
              return we(M, "No `clientMiddleware` export found"), M;
            }
          : void 0,
        shouldRevalidate: async () => {
          let M = await T();
          return Tn(R.path, M, l, n, s);
        },
    ...
    let S = _r(e, t, r, n, a, l.id, i, s);
    return S.length > 0 && (R.children = S), R;
  });
}
function Tn(e, t, r, n, a) {
  if (a) return Nl(r.id, t.shouldRevalidate, a);
  if (!n && r.hasLoader && !r.hasClientLoader) {
    let o = e ? kn(e)[1].map((s) => s.paramName) : [];
...
function Fl({ sri: e, ...t }, r) {
  ...
  o.forEach((s) => {
    let l = Ae(r.routes, s, r.basename);
...
function bs(e, t, r, n, a, o) {
  f.useEffect(() => {
    if (!Or(a, n) || window.navigator?.connection?.saveData === !0) return;
    function i(h) {
      let d =
        h.tagName === "FORM"
    ...
    async function s() {
      document
        ...
        .forEach(i);
      let h = Array.from(At.keys()).filter((d) =>
        It.has(d) ? (At.delete(d), !1) : !0
      );
      if (h.length !== 0)
        try {
          await va(
...
var or = "react-router-manifest-version";
async function va(e, t, r, n, a, o, i, s, l, u) {
  const h = new URLSearchParams();
  h.set("paths", e.sort().join(",")), h.set("version", r.version);
  let d = new URL(jl(s, i), window.location.origin);
  if (((d.search = h.toString()), d.toString().length > $l)) {
    At.clear();
    return;
  }
  let p;
  try {
    ...
    if (R.ok) {
      if (R.status === 204 && R.headers.has("X-Remix-Reload-Document")) {
        ...
        try {
          if (sessionStorage.getItem(or) === r.version) {
            console.error(
              "Unable to discover routes due to manifest version mismatch."
            );
            return;
          }
          sessionStorage.setItem(or, r.version);
        } catch {}
  ...
  let g = new Set(Object.keys(r.routes)),
    E = Object.values(p).reduce(
      (R, S) => (S && !g.has(S.id) && (R[S.id] = S), R),
      {}
    );
  Object.assign(r.routes, E), e.forEach((R) => Ul(R, It));
  let L = new Set();
  Object.values(E).forEach((R) => {
    R && (!R.parentId || !E[R.parentId]) && L.add(R.parentId);
  }),
    L.forEach((R) => l(R || null, _r(E, n, null, a, o, R)));
}
function Ul(e, t) {
  if (t.size >= Il) {
...
var Mn = "data-react-router-critical-css";
function Ss({ nonce: e }) {
  let { isSpaMode: t, manifest: r, routeModules: n, criticalCss: a } = et(),
    { errors: o, matches: i } = zt(),
    s = Ar(i, o, t),
    l = f.useMemo(() => xl(s, n, r), [s, n, r]);
  return f.createElement(
    f.Fragment,
    null,
    typeof a == "string"
    ...
    l.map(({ key: u, link: h }) =>
      Mr(h)
        ? f.createElement(ga, { key: u, nonce: e, ...h })
        : f.createElement("link", { key: u, nonce: e, ...h })
    )
  );
}
function ga({ page: e, ...t }) {
  let { router: r } = Nr(),
    n = f.useMemo(() => Ae(r.routes, e, r.basename), [r.routes, e, r.basename]);
  return n ? f.createElement(Wl, { page: e, matches: n, ...t }) : null;
}
function Bl(e) {
...
function Wl({ page: e, matches: t, ...r }) {
  let n = Me(),
    { manifest: a, routeModules: o } = et(),
    { basename: i } = Nr(),
    { loaderData: s, matches: l } = zt(),
    u = f.useMemo(() => Pn(e, t, l, a, n, "data"), [e, t, l, a, n]),
    h = f.useMemo(() => Pn(e, t, l, a, n, "assets"), [e, t, l, a, n]),
    d = f.useMemo(() => {
      ...
      if (
        (t.forEach((S) => {
          ...
          !b ||
            !b.hasLoader ||
            ((!u.some((T) => T.route.id === S.route.id) &&
              S.route.id in s &&
  ...
  return f.createElement(
    ...
    p.map((E) =>
      f.createElement("link", { key: E, rel: "modulepreload", href: E, ...r })
    ),
    g.map(({ key: E, link: L }) =>
      f.createElement("link", { key: E, nonce: r.nonce, ...L })
    )
  );
}
function xs() {
  let { isSpaMode: e, routeModules: t } = et(),
    { errors: r, matches: n, loaderData: a } = zt(),
    o = Me(),
    i = Ar(n, r, e),
    s = null;
  ...
  return f.createElement(
    ...
    l.flat().map((d) => {
      ...
      if ("tagName" in d) {
        ...
        let E = p;
        return f.createElement(E, { key: JSON.stringify(g), ...g });
      }
      if ("title" in d)
        return f.createElement("title", { key: "title" }, String(d.title));
      if (
        ("charset" in d &&
        ...
        return typeof d.charSet == "string"
          ? f.createElement("meta", { key: "charSet", charSet: d.charSet })
          : null;
      if ("script:ld+json" in d)
        try {
          ...
          return f.createElement("script", {
            ...
            dangerouslySetInnerHTML: { __html: fl(p) },
          });
        } catch {
          return null;
        }
      return f.createElement("meta", { key: JSON.stringify(d), ...d });
    })
  );
}
function Yl(e) {
...
function Jl(e) {
  let {
    ...
    { router: s, static: l, staticContext: u } = Nr(),
    { matches: h } = zt(),
    d = Qn(),
    p = Or(o, i);
...
${g.map((M, D) => {
  let A = `route${D}`,
    y = t.routes[M.route.id];
  we(y, `Route ${M.route.id} not found in manifest`);
  let {
    ...
    se = [
      ...(O ? [{ module: O, varName: `${A}_clientAction` }] : []),
      ...(W ? [{ module: W, varName: `${A}_clientLoader` }] : []),
      ...(X ? [{ module: X, varName: `${A}_clientMiddleware` }] : []),
      ...(V ? [{ module: V, varName: `${A}_HydrateFallback` }] : []),
      { module: ae, varName: `${A}_main` },
    ];
  if (se.length === 1) return `import * as ${A} from ${JSON.stringify(ae)};`;
  let ne = se.map((G) => `import * as ${G.varName} from "${G.module}";`).join(`
`),
    Z = `const ${A} = {${se.map((G) => `...${G.varName}`).join(",")}};`;
  return [ne, Z].join(`
`);
}).join(`
`)}
  ${
    p
      ? `window.__reactRouterManifest = ${JSON.stringify(Fl(t, s), null, 2)};`
      : ""
  }
  window.__reactRouterRouteModules = {${g
    .map((M, D) => `${JSON.stringify(M.route.id)}:route${D}`)
    .join(",")}};
...
import(${JSON.stringify(t.entry.module)});`
    ...
    L =
      $t || d
        ? []
        : Gl(t.entry.imports.concat(Dr(g, t, { includeHydrateFallback: !0 }))),
...
var Cs = class extends f.Component {
  constructor(e) {
  ...
  render() {
    return this.state.error
      ? f.createElement(wa, { error: this.state.error, isOutsideRemixApp: !0 })
      : this.props.children;
  }
};
function wa({ error: e, isOutsideRemixApp: t }) {
  console.error(e);
    ...
    : f.createElement(
        ...
        f.createElement(
          ...
          f.createElement(
            ...
            n,
            t ? f.createElement(Jl, null) : null
          )
        )
      );
}
var Kl =
  ...
  typeof window.document.createElement < "u";
try {
  Kl && (window.__reactRouterVersion = "7.11.0");
} catch {}
var Ea = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Ra = f.forwardRef(function (
    {
      onClick: t,
      discover: r = "render",
      prefetch: n = "none",
    ...
    let { basename: L, unstable_useTransitions: R } = f.useContext(Ee),
      S = typeof u == "string" && Ea.test(u),
      b = jn(u, L);
    u = b.to;
    let T = ui(u, { relative: a }),
      [M, D, A] = zl(n, g),
      y = ts(u, {
        replace: i,
        state: s,
    ...
    function O(X) {
      t && t(X), X.defaultPrevented || y(X);
    }
    let W = f.createElement("a", {
      ...g,
      ...A,
      href: b.absoluteURL || T,
      onClick: b.isExternal || o ? t : O,
      ref: Xl(E, D),
      target: l,
      "data-discover": !S && r === "render" ? "true" : void 0,
    });
    return M && !S
      ? f.createElement(f.Fragment, null, W, f.createElement(ga, { page: T }))
      : W;
  });
Ra.displayName = "Link";
var ql = f.forwardRef(function (
  {
    "aria-current": t = "page",
    caseSensitive: r = !1,
    className: n = "",
  ...
  let d = yt(i, { relative: u.relative }),
    p = Me(),
    g = f.useContext(Ze),
    { navigator: E, basename: L } = f.useContext(Ee),
    R = g != null && ss(d) && s === !0,
    S = E.encodeLocation ? E.encodeLocation(d).pathname : d.pathname,
    b = p.pathname,
    T =
  ...
  let D = b === S || (!a && b.startsWith(S) && b.charAt(M) === "/"),
    A =
      T != null &&
      (T === S || (!a && T.startsWith(S) && T.charAt(S.length) === "/")),
    y = { isActive: D, isPending: A, isTransitioning: R },
    O = D ? t : void 0,
    W;
  typeof n == "function"
    ? (W = n(y))
...
var Ql = f.forwardRef(
  (
    ...
    let { unstable_useTransitions: L } = f.useContext(Ee),
      R = as(),
      S = os(s, { relative: u }),
      b = i.toLowerCase() === "get" ? "get" : "post",
      T = typeof s == "string" && Ea.test(s),
      M = (D) => {
        if ((l && l(D), D.defaultPrevented)) return;
        D.preventDefault();
        let A = D.nativeEvent.submitter,
          y = A?.getAttribute("formmethod") || i,
          O = () =>
            R(A || D.currentTarget, {
              fetcherKey: t,
              method: y,
...
Ql.displayName = "Form";
function Zl({ getKey: e, storageKey: t, ...r }) {
  let n = f.useContext(Bt),
    { basename: a } = f.useContext(Ee),
    o = Me(),
    i = Cr();
  is({ getKey: e, storageKey: t });
  let s = f.useMemo(() => {
    if (!n || !e) return null;
    let u = yr(o, i, a, e);
  ...
  return f.createElement("script", {
    ...
    suppressHydrationWarning: !0,
    dangerouslySetInnerHTML: {
      __html: `(${l})(${JSON.stringify(t || pr)}, ${JSON.stringify(s)})`,
    },
  });
}
Zl.displayName = "ScrollRestoration";
function ba(e) {
  return `${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`;
}
function kr(e) {
  ...
  return f.useCallback(
    (p) => {
      if (ji(p, t)) {
        ...
        l ? f.startTransition(() => E()) : E();
      }
    },
    [h, u, d, r, n, t, e, a, o, i, s, l]
  );
}
var rs = 0,
  ns = () => `__${String(++rs)}__`;
function as() {
  let { router: e } = kr("useSubmit"),
  ...
  return f.useCallback(
    async (o, i = {}) => {
      let { action: s, method: l, encType: u, formData: h, body: d } = zi(o, t);
      if (i.navigate === !1) {
        let p = i.fetcherKey || ns();
        await n(p, r, i.action || s, {
...
function yr(e, t, r, n) {
  ...
  return (
    n &&
      (r !== "/"
        ? (a = n({ ...e, pathname: be(e.pathname, r) || e.pathname }, t))
        : (a = n(e, t))),
    a == null && (a = e.key),
    a
  );
}
function is({ getKey: e, storageKey: t } = {}) {
  let { router: r } = kr("useScrollRestoration"),
    { restoreScrollPosition: n, preventScrollReset: a } = es(
...
function ss(e, { relative: t } = {}) {
  let r = f.useContext(Rr);
  Y(
    r != null,
    "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?"
  );
  let { basename: n } = kr("useViewTransitionState"),
    a = yt(e, { relative: t });
  ...
  return kt(a.pathname, i) != null || kt(a.pathname, o) != null;
}
export {
  je as E,
  Bt as F,
